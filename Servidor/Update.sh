...
for file in arquivo-*.txt; do
    ...
    awk -v ip="$ip" -v nome_arquivo="$nome_arquivo" -F',' '$1 == ip && $3 == nome_arquivo { $2 = "Livre"; print }' $arquivo_csv_1 > temp1.csv
    mv temp1.csv $arquivo_csv_1
    
    awk -v nome_arquivo="$nome_arquivo" -F',' '$1 == nome_arquivo { $2 = "2"; print }' $arquivo_csv_2 > temp2.csv
